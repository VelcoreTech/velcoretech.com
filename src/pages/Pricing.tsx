...
const compareRows: CompareRow[] = [
  ...
  { id: "backup-recovery", label: "Backup, Recovery & Ransomware Readiness", icon: HardDrive, essential: { type: "check" }, secure: { type: "check" }, complete: { type: "check" }, href: "/services/cloud#backup-recovery" },

  // === IDENTITY & ACCESS ===
  { id: "identity-access", label: "Identity & Access Management", icon: KeyRound, essential: { type: "check" }, secure: { type: "check" }, complete: { type: "check" }, href: "/services/governance#identity-access" },
  ...
  { id: "network-firewall", label: "Network & Firewall Engineering", icon: Wifi, essential: { type: "check" }, secure: { type: "check" }, complete: { type: "check" }, href: "/services/networking#network-firewall" },

  // === SECURITY SERVICES - Add-on for Essential, included in Secure/Complete ===
  { id: "governance-compliance", label: "Governance & Compliance Readiness", icon: FileCheck2, essential: { type: "addon" }, secure: { type: "check" }, complete: { type: "check" }, href: "/services/audit-ready#governance-compliance" },
