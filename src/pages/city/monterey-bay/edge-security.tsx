...
export default function SantaCruzEdgeSecurity() {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Edge Security Monterey Bay | Velcore Tech</title>
        <meta
          name="description"
        ...
        <div className="container-tight">
          <div className="rounded-3xl border border-border bg-card p-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link to="/services#edge-security" className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors">
              ...
              <Link to="/city/santa-cruz/cloud-migration" className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors">
