  ...
  <div className="container-tight">
    <div className="rounded-3xl border border-border bg-card p-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link
          to="/services#governance-compliance"
  ...
  <div className="container-tight">
    <div className="rounded-3xl border border-border bg-card p-8">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Button variant="outline" asChild>
          <Link to="/services#governance-compliance">Governance & Compliance</Link>
        </Button>

        <Button variant="outline" asChild>
          <Link to="/city/santa-cruz/Managed-IT">Santa Cruz Managed IT</Link>
        </Button>

        <Button variant="outline" asChild>
          <Link to="/city/santa-cruz/edge-security">Santa Cruz Edge Security</Link>
        </Button>

        <Button variant="outline" asChild>
          <Link to="/city/santa-cruz/cloud-migration">Santa Cruz Cloud Migration</Link>
        </Button>

        <Button variant="outline" asChild>
          <Link to="/city/santa-cruz">Santa Cruz City Hub</Link>
        </Button>
      </div>
    </div>
  </div>
