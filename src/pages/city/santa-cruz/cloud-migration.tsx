        ...
        <div className="container-tight relative z-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <Button variant="outline-glow" size="xl" asChild>
              <Link to={`/assessment${getTrackingParams('santa-cruz-cloud-migration', 'hero', 'assessment')}`}>
                Start Assessment
            ...
            <Button variant="outline-glow" size="xl" asChild>
              <a 
                href={`${SCHEDULER_URL}${getTrackingParams('santa-cruz-cloud-migration', 'hero', 'schedule_consultation')}`} 
                target="_blank" 
                rel="noreferrer"
              >
        ...
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                icon: ClipboardCheck,
                title: "Migration Planning + Cutover",
              ...
              },
              {
                ...
                text: "M365 & Google Workspace, Email/data migration planning, cutover sequencing, and validation—minimizing user disruption.",
              },
              {
                icon: Lock,
              ...
              },
              {
                ...
                text: "MFA enforcement, admin protections, onboarding/offboarding patterns. Access model & baseline policies so auth becomes a strength, not a risk.",
              },
            ].map((x) => (
              <motion.div
                key={x.title}
        ...
        <div className="container-tight">
          <div className="rounded-3xl border border-border bg-card p-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link 
                to={`/services#m365-cloud${getTrackingParams('santa-cruz-cloud-migration', 'related', 'm365_cloud')}`} 
              ...
              <Link 
                to={`/city/santa-cruz/Managed-IT${getTrackingParams('santa-cruz-cloud-migration', 'related', 'managed_it')}`} 
                className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors"
              >
              ...
              <Link 
                to={`/city/santa-cruz/cybersecurity${getTrackingParams('santa-cruz-cloud-migration', 'related', 'cybersecurity')}`} 
                className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors"
              >
              ...
              <Link 
                to={`/city/santa-cruz/edge-security${getTrackingParams('santa-cruz-cloud-migration', 'related', 'edge_security')}`} 
                className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors"
              >
              ...
              <Link 
                to={`/city/santa-cruz${getTrackingParams('santa-cruz-cloud-migration', 'related', 'santa_cruz_overview')}`} 
                className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors"
              >
              ...
              <Link 
                to={`/services${getTrackingParams('santa-cruz-cloud-migration', 'related', 'all_services')}`} 
                className="rounded-2xl border border-border bg-background/60 p-4 hover:bg-background transition-colors"
              >
      ...
      <section className="section-padding bg-card">
        <div className="container-tight">
          <div className="p-10 rounded-3xl bg-background border border-border text-center">
            ...
            <Button variant="outline-glow" size="xl" asChild>
              <Link to={`/assessment${getTrackingParams('santa-cruz-cloud-migration', 'final_cta', 'assessment')}`}>
