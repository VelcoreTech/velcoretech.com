...
export default function Home() {
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            address: {
              "@type": "PostalAddress",
              streetAddress: "280 Harvey West Blvd",
      ...
      {/* Trust block — frameworks we align with + stack we operate.
          Honest by construction: no claimed partner-tier badges. */}
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  { icon: ShieldCheck, label: "SOC 2 Readiness" },
                  { icon: Shield, label: "HIPAA-aware" },
                  { icon: ClipboardCheck, label: "NIST CSF" },
                  { icon: Award, label: "ISO 27001-aligned" },
                  { icon: FileCheck2, label: "CIS Controls" },
                ].map(({ icon: Icon, label }) => (
                  <span
                    key={label}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  { icon: Globe, label: "Cloudflare Edge" },
                  { icon: KeyRound, label: "Identity Governance" },
                  { icon: ShieldCheck, label: "Managed EDR" },
                  { icon: HardDrive, label: "Backup & DR" },
                ].map(({ icon: Icon, label }) => (
                  <span
                    key={label}
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium bg-secondary text-secondary-foreground border border-border"
