            ...
            >
              <div className="sticky top-24 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    href="https://maps.google.com/?q=280+Harvey+West+Blvd,+Santa+Cruz,+CA+95060"
                    target="_blank"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-medium">280 Harvey West Blvd</p>
      ...
      <section className="pb-20 bg-background">
        <div className="container-tight">
          <div className="rounded-2xl overflow-hidden border border-border">
            <iframe
              title="Velcore Tech Office Location"
              src="https://maps.google.com/maps?q=280+Harvey+West+Blvd,+Santa+Cruz,+CA+95060&output=embed"
              width="100%"
              height="320"
