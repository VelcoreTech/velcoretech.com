...
export default function ManagementConsulting() {
  ...
  const whatWeCover = useMemo(
    () => [
      ...
      {
        title: "M&A Support",
        desc: "Comprehensive technology due diligence and post-acquisition integration.",
        items: [
          "Pre-deal technology assessment",
  ...
  const related = useMemo(
    () => [
      ...
      { title: "Governance", to: "/services/governance", icon: Building2 },
      { title: "Assessment", to: "/services/assessment", icon: CheckCircle2 },
    ],
    []
  );
