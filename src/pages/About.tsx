...
const capabilities = [
  ...
  },
  {
    ...
    items: [
      ...
      "Mergers & acquisitions IT due diligence and integration",
...
const team = [
  {
    ...
    role: "Founder & CEO",
    image: amrx,
    bio: "Site Reliability Engineer with 15+ years in enterprise IT and cybersecurity. Leads our system architecture and networking security",
    social: {
        ...
        <div className="container-tight relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-primary/10 text-primary border border-primary/20 mb-4">
              ...
              <span>About Velcore Tech</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold tracking-tight mb-4">
              Building the Foundation for
              <span className="text-gradient block mt-2">Secure, Scalable Growth</span>
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              We architect and operate security-first environments where reliability meets defensibility. 
              Identity, cloud, network, and edge—unified under measurable standards, not assumptions. 
              Built for clarity. Operated for outcomes.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Velcore Tech was founded to address a persistent gap: organizations need IT that's 
                  both operationally reliable and security-defensible. We built a model that delivers 
                  both—with clear accountability, measurable standards, and executive-level visibility.
                </p>
                <p>
                  Our focus: reduce operational risk, strengthen cybersecurity posture, and ensure 
                  leadership has visibility into the systems the business depends on.
                </p>
        ...
        <div className="container-tight">
          <div className="text-center mb-8">
            ...
            >
              ...
              {showTeam ? "Hide Velcore Team" : "Meet the Velcore Team"}
          ...
          <AnimatePresence>
            {showTeam && (
              ...
              >
                <SectionHeader
                  badge="Velcore Team"
                  description="Experienced professionals dedicated to your security and operational success."
                />

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center mt-12">
                ...
                <div className="mt-10 text-center">
                  <p className="text-sm text-muted-foreground mb-4">
                    Our leadership team brings decades of combined experience in enterprise IT and cybersecurity.
                  </p>
